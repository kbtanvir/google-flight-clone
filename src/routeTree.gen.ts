...
const AuthenticatedSitesIndexLazyImport = createFileRoute(
...
const AuthenticatedSitesIndexLazyRoute =
  AuthenticatedSitesIndexLazyImport.update({
    id: '/sites/',
    path: '/sites/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/sites/index.lazy').then((d) => d.Route),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/sites/': {
      ...
      path: '/sites'
      fullPath: '/sites'
      preLoaderRoute: typeof AuthenticatedSitesIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/tasks/': {
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedSitesIndexLazyRoute: typeof AuthenticatedSitesIndexLazyRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedSitesIndexLazyRoute: AuthenticatedSitesIndexLazyRoute,
...
export interface FileRoutesByFullPath {
  ...
  '/sites': typeof AuthenticatedSitesIndexLazyRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/sites/': typeof AuthenticatedSitesIndexLazyRoute
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/sites/": {
      "filePath": "_authenticated/sites/index.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/tasks/": {
